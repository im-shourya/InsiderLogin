        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-10">
            <div className="lg:col-span-2 py-6">
                <div className="flex items-center mb-4 justify-between">
                    <h2 className="font-bold text-black">Transactions</h2>
                    ...
                    <div className="space-y-5">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4 ">
                                <div className="w-11 h-11 rounded-xl bg-[#eef1f6] flex items-center justify-center">
                                    <img src={transaction} alt="right" className="w-5 h-5 drop-shadow-sm" />
                                </div>
                                <div>
                                    <p className="font-semibold text-[15px] text-[#2d332f]">Payment Sent to Shakir</p>
                                </div>
                            </div>
                            <span className="font-bold text-[#d9534f] text-sm">$560.00</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                <div className="w-11 h-11 rounded-xl bg-[#eef1f6] flex items-center justify-center">
                            ...
                            <span className="font-bold text-[#2d332f] text-sm">$12,200.00</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                <div className="w-11 h-11 rounded-xl bg-[#eef1f6] flex items-center justify-center">
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="font-bold text-[#d9534f] text-sm">$5560.00</span>
                        </div>
                    </div>
                </div>
            </div>
